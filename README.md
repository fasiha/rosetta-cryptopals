...
I’d guess this isn’t meant to be a realistic scenario, since, if the ciphertext lacked repeats, or if the repeats weren’t so kind as to line up on 16-byte boundaries, this simple-minded approach would have failed.
